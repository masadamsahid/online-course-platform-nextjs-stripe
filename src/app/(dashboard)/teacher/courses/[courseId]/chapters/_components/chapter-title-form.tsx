...
const ChapterTitleForm = ({ initialData, courseId, chapterId, ...props }: ChapterTitleFormProps) => {
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-4 mt-4">
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  <FormControl>
                    <Input {...field} disabled={isSubmitting} placeholder="e.g. 'Intro to the course...'" />
                  </FormControl>
                  <FormMessage/>
                </FormItem>
              )}
